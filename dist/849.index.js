...
__webpack_require__.d(__webpack_exports__, {
  checkLocation: () => (/* binding */ checkLocation),
...
function canonical_revocationPayload(provenanceId) {
  if (typeof provenanceId !== 'string' || provenanceId.length === 0) {
    throw new CanonicalError('provenanceId is required');
  }
...
;// CONCATENATED MODULE: ./node_modules/provenance-protocol/src/verify.js
/**
